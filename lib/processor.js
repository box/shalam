...
var SPRITE_ALT_DECL_NAME = '-shalam-sprite';


/**
 * Returns a sprite declaration object given a node from a CSS parse tree.
...
Processor.prototype.search = function search() {
    walker.walk(this.parsed, function(ruleset) {
        ...
        for (var i = 0; i < ruleset.content.length; i++) {
            ...
            if (decl.ident !== SPRITE_DECL_NAME && decl.ident !== SPRITE_ALT_DECL_NAME) continue;
 ...
 * @returns {void}
 */
Processor.prototype.applyLayout = function(layout, layoutCompat, spriteDestination) {
 ...
 * @returns {Dimension} The new CSS dimension object.
 */
...
module.exports.generateRulesetSpriteData = generateRulesetSpriteData;
